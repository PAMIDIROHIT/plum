...
class ClaimModel(Base):
    ...
    rejection reason codes, confidence score, reasoning traces, and audit logs.
    """
    ...
    confidence_score = Column(Float, default=0.95)       # AI + rule engine confidence
    ...
    adjudication_meta = Column(Text, default="{}")       # Serialized DeepSeek/local meta
